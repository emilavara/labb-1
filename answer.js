...
if (card1 + card2 + card3 == 21) { //equals too
    status = "black jack";
}

if (card1 + card2 + card3 > 21) { //higher
    status = "busted"
}

if (card1 + card2 + card3 < 21) { //lower
    status = "safe";
}
...
var dealercards = dealer1 + dealer2 + dealer3; // sum of dealer cards
...
switch(myFruit) {
    case 'banana':
        fruitresult = "The banana is yellow.";
        break;
    case 'apple':
        fruitresult = "The apple is green.";
        break;
    case 'kiwi':
        fruitresult = "The kiwi is green.";
        break;
    case 'plum':
        fruitresult = "The plum is purple.";
        break;
}
...
switch(myFruit) {
    ...
    case 'plum':
        ...
        break;
    default:
        fruitresult = "That is an unknown fruit."
}
